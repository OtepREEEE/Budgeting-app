...
class MainWindow:
    def __init__(self):
        ...
        self.root.geometry("920x540") #set dimention size
        self.root.resizable(width=False, height=False) #doesnt allow window resize
        self.root.title("Budget Tool") #set Window title
        #self.textBox = tk.Text(height=10, width=10)
        #self.textBox.pack()
        self.style = ('Monospace', 18)
        self.draw('Hello! Welcome to the budget app!')
        self.buttons()
        self.root.mainloop() #keep ui alive

    def draw(self, msg):
        self.frameText = tk.Frame(self.root, height=19, width=50)
        self.textBox = tk.Text(height=19, width=50, relief='flat', bg='light yellow', font=self.style)
    ...
    def buttons(self):
        self.frame = tk.Frame(self.root, height=1, width=60)
        ...
        self.viewBudget = tk.Button(self.frame, text='View Spending Budget', command=self.viewBudgetPlan, width=20)
    ...
    def popUp(self):
        ...
        self.popUp.title("House pay & Bills")
        self.popUp.resizable(width=False, height=False)
        self.rentLabel = tk.Label(self.popUp, text="Housing:")
